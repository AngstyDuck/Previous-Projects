...
outputImage = cv2.cvtColor(image, cv2.COLOR_BGR2GRAY)
#----------------------------------------------------------------------------
...
edges = cv2.Canny(outputImage, 75, 150)
np.savetxt(r'/home/pi/dw1d/Datafiles/data_black_edges.txt',edges,fmt='%d')
